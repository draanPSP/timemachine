...
namespace {
	...
	inline auto const cache1Ptr = reinterpret_cast<v_v_function_t const>(0x04000e34);
	inline auto const cache2Ptr = reinterpret_cast<v_v_function_t const>(0x04000e64);
