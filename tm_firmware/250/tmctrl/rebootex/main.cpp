...
namespace {
	...
	inline auto const cache1Ptr = reinterpret_cast<v_v_function_t const>(0x88c03b00);
	inline auto const cache2Ptr = reinterpret_cast<v_v_function_t const>(0x88c03624);
...
int main(s32 const a0, s32 const a1, s32 const a2, s32 const a3) {
	...
	_sw(0x03e00008, 0x88c01ce8);
	_sw(0x24020001, 0x88c01cec);
