...
namespace {
	...
	inline auto const cache1Ptr = reinterpret_cast<v_v_function_t const>(0x040010f0);
	inline auto const cache2Ptr = reinterpret_cast<v_v_function_t const>(0x04001120);
...
int main() {
	...
	MAKE_CALL(0x04000078, loadPayloadEx);

	//Change payload entry point to payloadex
	_sw(0x3C19883E, 0x0400b0b8);
