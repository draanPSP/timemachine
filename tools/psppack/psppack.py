...
def pack_prx(executable, psptag, oetag, is_pbp):
    ...
    if devkitversion is not None:
        psp_header.devkitversion = devkitversion
...
parser.add_argument('--devkitver', type=lambda x: int(x, 0), help='The Devkit Version to use')
